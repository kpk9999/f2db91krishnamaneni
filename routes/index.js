...
router.get('/', function (req, res) {
 res.render('index', { title: 'Anaconda App', user : req.user });
});
router.get('/register', function(req, res) {
 res.render('register', { title: 'Anaconda App Registration'});
});
...
router.get('/login', function(req, res) {
 res.render('login', { title: 'Anaconda App Login', user : req.user });
});
